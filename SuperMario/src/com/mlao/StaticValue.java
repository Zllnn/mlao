...
//            jump_L = ImageIO.read(new File(path + "s_mario_jump1_L.png"));
        ...
        for (int i = 1;i <= 2;i++) {
            try {
                run_L.add(ImageIO.read(new File(path + "s_mario_run"+ i +"_R.png")));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
...
//            obstacle.add(ImageIO.read(new File(path + "soil_base.png")));
            obstacle.add(ImageIO.read(new File(path + "blank.png")));
            obstacle.add(ImageIO.read(new File(path + "blank.png")));
            obstacle.add(ImageIO.read(new File(path + "blank.png")));
        } catch (IOException e) {
            e.printStackTrace();
...
//                mogu.add(ImageIO.read(new File(path + "fungus"+i+".png")));
                mogu.add(ImageIO.read(new File(path + "blank.png")));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
...
//                flower.add(ImageIO.read(new File(path + "flower1."+i+".png")));
                flower.add(ImageIO.read(new File(path + "blank.png")));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
